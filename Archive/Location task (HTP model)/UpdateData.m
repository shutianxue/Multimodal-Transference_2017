function Data = UpdateData(Data, tarPercent, correctness, anstime, condition, signalDirection)

s = condition;

Data.Data.PerCondition.StimVals{s} = [Data.Data.PerCondition.StimVals{s}; tarPercent];
...
Data.Data.Running.StimVals = [Data.Data.Running.StimVals; tarPercent];
