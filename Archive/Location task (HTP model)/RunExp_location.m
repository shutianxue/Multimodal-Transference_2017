...
function RunExp_location(subjectID,block,trials, trialsPr, nconditions, conditions)
...
for p = 1:TrialNPrac
    ...
    % Present stimulus
    PresentStimulus(tarPercent, signalDirection, beepN,beepT);
...
Record=ones(trialN,3+beepN)*99;          
     ...
     %     column 4-last: noiseRecordPerTrial 
...
for trialcount= 1:trialN
    ...
    % Present stimulus
    noiseRecordPerTrial=PresentStimulus(tarPercent, signalDirection, beepN,beepT);
